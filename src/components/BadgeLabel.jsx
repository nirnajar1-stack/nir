    ...
    return (
      <foreignObject x={cx - 75} y={cy - 22} width={150} height={44} className="overflow-visible pointer-events-none">
        <div className="flex flex-col items-center justify-center w-full h-full drop-shadow-md">
          <div className="bg-surface-container-lowest/85 backdrop-blur-sm border border-white/50 px-3 py-0.5 rounded-t-lg shadow-sm w-max max-w-full">
            <span className="text-on-surface text-[11px] font-extrabold tracking-wide truncate block text-center">
              {sub}
            </span>
          </div>
          <div className="bg-inverse-surface/90 backdrop-blur-sm px-2 py-0.5 rounded-b-lg shadow-sm border-t border-outline-variant/40 w-max">
            <span className="text-on-primary text-[10px] font-medium tracking-wide">
